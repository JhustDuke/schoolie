...
<nav class="navbar px-2 py-3 blue darken-3 ">
  ...
  <!-- logo  -->
    <div class="d-flex align-items-center">
      ...
      <!--search input  -->
   <div class="d-flex align-items-center gap-2 border px-2 py-1 rounded-pill">
  <input type="text" id="searchInput" class="form-control form-control-sm shadow-none white-text" placeholder="Search..."
    style="outline: none; border: none; background-color: transparent;" />  

  <!-- Tooltip -->
  <span>
    <i class="fa fa-info blue-grey yellow-text text-lighten-4 px-1 py-1 rounded-pill" aria-hidden="true" id="searchToolTip"></i>
  </span>
</div>
