...
import { ResponseToolkit, Auth } from "@hapi/hapi/lib/types/response";
...
export namespace Lifecycle {
	 ...
	 */
	type ReturnValue<Refs extends ReqRef = ReqRefDefaults> =
		| ReturnValueTypes<Refs>
		| Promise<ReturnValueTypes<Refs>>;
