...
import { PluginsStates, ServerRealm } from "@hapi/hapi/lib/types/plugin";
import { ResponseValue, ResponseObject } from "@hapi/hapi/lib/types/response";
import { RouteRules, RouteSettings } from "@hapi/hapi/lib/types/route";
import { Server, ServerAuthSchemeObjectApi } from "@hapi/hapi/lib/types/server";
import { HTTP_METHODS, PeekListener } from "@hapi/hapi/lib/types/utils";
...
export interface Request<Refs extends ReqRef = ReqRefDefaults> extends Podium {
	...
	generateResponse(
		...
		options?:
			| {
					...
					prepare?:
						| ((response: ResponseObject) => Promise<ResponseObject>)
						| undefined;
					marshal?:
						| ((response: ResponseObject) => Promise<ResponseValue>)
						| undefined;
	...
	log(
		tags: string | string[],
		data?: string | object | (() => string | object) | undefined
	): void;
