...
} from "@hapi/hapi/lib/types/server/server";
import { ReqRef, ReqRefDefaults } from "@hapi/hapi/lib/types/request";
...
export type ServerExtPointFunction<A = ServerApplicationState> = (
	server: Server<A>
) => void;
