...
import {
	...
	PluginProperties,
} from "@hapi/hapi/lib/types/plugin";
import {
	ReqRef,
	ReqRefDefaults,
	Request,
	RequestRoute,
} from "@hapi/hapi/lib/types/request";
import { ResponseToolkit } from "@hapi/hapi/lib/types/response";
import {
	RulesOptions,
	RulesProcessor,
	ServerRoute,
} from "@hapi/hapi/lib/types/route";
import { HTTP_METHODS, Lifecycle } from "@hapi/hapi/lib/types/utils";
import { ServerAuth } from "@hapi/hapi/lib/types/server/auth";
import { ServerCache } from "@hapi/hapi/lib/types/server/cache";
import {
	ContentDecoders,
	ContentEncoders,
} from "@hapi/hapi/lib/types/server/encoders";
import {
	ServerEventsApplication,
	ServerEvents,
} from "@hapi/hapi/lib/types/server/events";
import {
...
} from "@hapi/hapi/lib/types/server/ext";
import { ServerInfo } from "@hapi/hapi/lib/types/server/info";
import {
	ServerInjectOptions,
	ServerInjectResponse,
} from "@hapi/hapi/lib/types/server/inject";
import {
	ServerMethod,
	ServerMethodOptions,
	ServerMethodConfigurationObject,
	ServerMethods,
} from "@hapi/hapi/lib/types/server/methods";
import { ServerOptions } from "@hapi/hapi/lib/types/server/options";
import {
	ServerState,
	ServerStateCookieOptions,
} from "@hapi/hapi/lib/types/server/state";
...
type ExceptName<Property, ReservedKeys> = Property extends ReservedKeys
	? never
	: Property;
...
export class Server<A = ServerApplicationState> {
	 ...
	 */
	decoder<T extends keyof ContentDecoders>(
		encoding: T,
		decoder: ContentDecoders[T]
	): void;
	 ...
	 */
	decorate<P extends DecorateName>(
		type: "handler",
		property: P,
		method: HandlerDecorationMethod,
		options?: { apply?: boolean | undefined; extend?: never }
	): void;

	decorate<P extends DecorateName>(
		type: "request",
		property: ExceptName<P, ReservedRequestKeys>,
		method: (
	...
	decorate<P extends DecorateName>(
		type: "request",
		property: ExceptName<P, ReservedRequestKeys>,
		value: (existing: (...args: any[]) => any) => (request: Request) => any,
		options: { apply: true; extend: true }
	): void;
	decorate<P extends DecorateName>(
		type: "request",
		property: ExceptName<P, ReservedRequestKeys>,
		value: (request: Request) => any,
		options: { apply: true; extend?: boolean | undefined }
	): void;
	decorate<P extends DecorateName>(
		type: "request",
	...
	decorate<P extends DecorateName>(
		type: "toolkit",
		property: ExceptName<P, ReservedToolkitKeys>,
		method: (
			existing: (...args: any[]) => any
	...
	decorate<P extends DecorateName>(
		type: "toolkit",
		property: ExceptName<P, ReservedToolkitKeys>,
		value: (existing: (...args: any[]) => any) => any,
		options: { apply?: boolean | undefined; extend: true }
	): void;
	decorate<P extends DecorateName>(
		type: "toolkit",
	...
	decorate<P extends DecorateName>(
		type: "server",
		property: ExceptName<P, ReservedServerKeys>,
	...
	dependency(
		...
		after?: ((server: Server) => Promise<void>) | undefined
	): void;
	 ...
	 */
	encoder<T extends keyof ContentEncoders>(
		encoding: T,
		encoder: ContentEncoders[T]
	): void;
	...
	ext(
		event: ServerExtType,
		method: ServerExtPointFunction<A>,
	...
	): Promise<ServerInjectResponse<Result>>;
	 ...
	 */
	method(
		methods: ServerMethodConfigurationObject | ServerMethodConfigurationObject[]
	): void;
	...
	register<T, D>(
		plugins: Plugin<T, D>,
		options?: ServerRegisterOptions | undefined
	): Promise<this & D>;
	register<T, D>(
		plugin: ServerRegisterPluginObject<T, D>,
		options?: ServerRegisterOptions | undefined
	): Promise<this & D>;
	register(
		plugins: Plugin<any>[],
	...
	route<Refs extends ReqRef = ReqRefDefaults>(
		route: ServerRoute<Refs> | ServerRoute<Refs>[]
	): void;
 ...
 */
export function server<A = ServerApplicationState>(
