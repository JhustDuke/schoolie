import {
	...
	ResponseObject as ShotResponseObject,
} from "@hapi/shot";
import { PluginsStates } from "@hapi/hapi/lib/types/plugin";
import {
	AuthArtifacts,
	AuthCredentials,
	Request,
 ...
 * For context [Shot module](https://github.com/hapijs/shot)
 */
export interface ServerInjectResponse<Result = object>
	extends ShotResponseObject {
	/**
