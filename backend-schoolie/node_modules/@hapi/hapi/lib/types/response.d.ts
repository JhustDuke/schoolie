...
import { PeekListener, Lifecycle, Json } from "@hapi/hapi/lib/types/utils";
import { ServerStateCookieOptions } from "@hapi/hapi/lib/types/server";
...
export interface ResponseObject extends Podium {
	...
	etag(
		tag: string,
		options?: { weak: boolean; vary: boolean } | undefined
	): ResponseObject;
	...
	header(
		name: string,
		value: string,
		options?: ResponseObjectHeaderOptions | undefined
	): ResponseObject;
...
> {
	...
	readonly data?:
		| AuthenticationData<AuthUser, AuthApp, CredentialsExtra, ArtifactsExtra>
		| undefined;
}
...
export interface ResponseToolkit<Refs extends ReqRef = ReqRefDefaults> {
	...
	>(
		data: AuthenticationData<
			...
			ArtifactsExtra
		>
	): Auth<AuthUser, AuthApp, CredentialsExtra, ArtifactsExtra>;
