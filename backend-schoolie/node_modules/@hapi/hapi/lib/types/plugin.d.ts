import { RequestRoute } from "@hapi/hapi/lib/types/request";
import { RouteOptions } from "@hapi/hapi/lib/types/route";
import { Server } from "@hapi/hapi/lib/types/server";
import { Lifecycle } from "@hapi/hapi/lib/types/utils";
 ...
 */
export interface NamedPlugin<T, D = void>
	extends PluginBase<T, D>,
		PluginNameVersion {}

/**
 * A plugin that is registered by its package.json file.
 */
export interface PackagedPlugin<T, D = void>
	extends PluginBase<T, D>,
		PluginPackage {}
...
export interface ServerRegisterPluginObjectDirect<T, D>
	extends ServerRegisterOptions {
	/**
	 * a plugin object.
	 */
	plugin: Plugin<T, D>;
...
export interface ServerRegisterPluginObjectWrapped<T, D>
	extends ServerRegisterOptions {
	/**
	 * a plugin object.
	 */
